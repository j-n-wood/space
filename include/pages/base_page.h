...
public:
    ...
    virtual void deactivate() {};                // on change away from this page, clear any state if needed
    ...
    virtual void renderDebug() {}                 // debug-only overlay drawing; runs after render() when Overlay::debug is set
    ...
    static void setWindowSize(int width, int height)
    {
        ...
        sideBarDest = {0, (float)(height - 120 * 4), 51 * 4, 103 * 4};  // keep sidebar width fixed at 192
